...
| 🌐 多言語 | 中国語/英語/日本語 | ✅ |
| 🔋 低バッテリー通知 | バッテリー20%以下で通知 | ✅ |
| 🔄 自動再接続 | ヘッドセット切断後自動再接続 | ✅ |
| 📖 初回ガイド | 初回起動時に機能紹介を表示 | ✅ |
...
<table>
<tr>
<td align="center"><img src="docs/earphone_page.jpg" width="270" style="border-radius: 12px;" alt="ロック画面"/></td>
<td align="center"><img src="docs/module_page.jpg" width="270" style="border-radius: 12px;" alt="モジュールページ"/></td>
</tr>
<tr>
<td align="center">🔒 ロック画面</td>
